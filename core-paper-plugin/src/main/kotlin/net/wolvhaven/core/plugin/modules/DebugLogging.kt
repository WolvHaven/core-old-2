...
class DebugLogging(private val plugin: WhCorePlugin) : WhModule, Listener {

    init {
        plugin.server.pluginManager.registerEvents(this, plugin)
    }

    val permRoot = "${net.wolvhaven.core.plugin.WhCorePlugin.permRoot}.logging"
    val permissionDisconnectReason = "$permRoot.disconnectReason"
